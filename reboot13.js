...
document.getElementById("Subject1").innerHTML = "ES";
	...
	document.getElementById("Subject1").innerHTML = "1A3-1:EME & 1A3-2:BEE";
	...
	document.getElementById("Subject1").innerHTML = "1A3-1:WS & 1A3-2:EME";
	...
	document.getElementById("Subject5").innerHTML = "1A3-1:Maths & 1A3-2:CS";
	document.getElementById("Link5").innerHTML ="1A3-1:" + MathLink + "<br>" +"1A3-2:" + CsLink;
}

else if( day == "Saturday"){
	document.getElementById("Subject1").innerHTML = "1A3-1:CS & 1A3-2:Maths";
	document.getElementById("Link1").innerHTML = "1A3-1:" + CsLink + "<br>" +"1A3-2:" + MathLink;

	document.getElementById("Subject2").innerHTML = "1A3-1:CS & 1A3-2:Maths"
	...
	document.getElementById("Subject5").innerHTML = "1A3-1:BEE & 1A3-2:WS";
